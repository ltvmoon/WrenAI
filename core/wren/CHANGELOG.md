...
## [0.11.0](https://github.com/ltvmoon/WrenAI/compare/wren-v0.10.1...wren-v0.11.0) (2026-06-25)


### ⚠ BREAKING CHANGES

* **wren:** rename PyPI package from wren-engine to wrenai ([#2315](https://github.com/ltvmoon/WrenAI/issues/2315))
...
* **context:** bind a connection profile to a project ([#2251](https://github.com/ltvmoon/WrenAI/issues/2251)) ([41fbe41](https://github.com/ltvmoon/WrenAI/commit/41fbe411fd1f1bb7a4080fbcedc7c886678276d1))
...
* **wren-core:** support composite (multi-column) primary keys ([#2345](https://github.com/ltvmoon/WrenAI/issues/2345)) ([d33917f](https://github.com/ltvmoon/WrenAI/commit/d33917f046f4ac0abddbbce9ce6c9c10b5adb10a))
...
* **wren:** add dbt import workflow ([#2279](https://github.com/ltvmoon/WrenAI/issues/2279)) ([0bd16b8](https://github.com/ltvmoon/WrenAI/commit/0bd16b8a95c7f599488177f9a56e232c17760e25))
...
* **wren:** add v5 project layout (schema_version 5) ([#2386](https://github.com/ltvmoon/WrenAI/issues/2386)) ([d50b9bc](https://github.com/ltvmoon/WrenAI/commit/d50b9bcc58d4242e39b3d728c328b446e074997d))
* **wren:** build MDL manifests from OSI semantic models ([#2322](https://github.com/ltvmoon/WrenAI/issues/2322)) ([983cf8b](https://github.com/ltvmoon/WrenAI/commit/983cf8bff589b5028b611bcb1ef89834990f9517))
...
* **wren:** GenBI app build & deploy — semantic layer → shareable web app ([#2348](https://github.com/ltvmoon/WrenAI/issues/2348)) ([67257bf](https://github.com/ltvmoon/WrenAI/commit/67257bf2a867df8271c52e0aa352e9b4c3ae155e))
...
* **wren:** query MDL views in the SDK rewriter and strict mode ([#2334](https://github.com/ltvmoon/WrenAI/issues/2334)) ([731c9c0](https://github.com/ltvmoon/WrenAI/commit/731c9c0d92e665254afb2eff129f9e061a932fd2))
* **wren:** serve agent skills and reference docs from the CLI ([#2329](https://github.com/ltvmoon/WrenAI/issues/2329)) ([cbd10cd](https://github.com/ltvmoon/WrenAI/commit/cbd10cd0ae31876e9dc8a0d113c482b29b6f5ad2))


### Bug Fixes

* disable transformers progress bar on Windows ([#2368](https://github.com/ltvmoon/WrenAI/issues/2368)) ([f91529b](https://github.com/ltvmoon/WrenAI/commit/f91529b62c6367440f0a6a87f894d3765663127f))
* ensure UTF-8 encoding for YAML file operations on Windows ([#2357](https://github.com/ltvmoon/WrenAI/issues/2357)) ([322bd79](https://github.com/ltvmoon/WrenAI/commit/322bd798da9e50945af6bc2132622b908073ce7c))
* **memory:** avoid identifier columns in aggregation seed queries ([#2358](https://github.com/ltvmoon/WrenAI/issues/2358)) ([d5e7879](https://github.com/ltvmoon/WrenAI/commit/d5e78790b95fe188e5e208cc7b794bdf550a44e8))
* **mysql:** handle brackets in connection URLs ([#2367](https://github.com/ltvmoon/WrenAI/issues/2367)) ([8850abe](https://github.com/ltvmoon/WrenAI/commit/8850abe74d9442062354953d06136dfc3823955a))
...
* **wren:** honor SQL identifier case across policy, extract, and CTE rewriter ([#2310](https://github.com/ltvmoon/WrenAI/issues/2310)) ([9b5fe22](https://github.com/ltvmoon/WrenAI/commit/9b5fe22ee35209ec23ec3bd4fe2b04133407a8bc))
* **wren:** load cubes from folder-per-entity layout ([#2350](https://github.com/ltvmoon/WrenAI/issues/2350)) ([6f2542e](https://github.com/ltvmoon/WrenAI/commit/6f2542e117cd4d7b0631745cd400cbf3f5a948d7))
* **wren:** run full unit suite in CI and fix upgrade tests for schema_version 5 ([#2388](https://github.com/ltvmoon/WrenAI/issues/2388)) ([c36e56e](https://github.com/ltvmoon/WrenAI/commit/c36e56ebd285c0c07444ce7deb900055fe7cf538))
* **wren:** support Databricks catalog ([#2340](https://github.com/ltvmoon/WrenAI/issues/2340)) ([5e58ef6](https://github.com/ltvmoon/WrenAI/commit/5e58ef633fe3e657f99e512a3fdd33b61d03dbdd))
...
* **cli:** use find_spec instead of eager import to detect memory extra ([#2352](https://github.com/ltvmoon/WrenAI/issues/2352)) ([81d15fa](https://github.com/ltvmoon/WrenAI/commit/81d15faa3cadc7c5bfeb716f1a241e16cac25c04))


### Dependencies

* clear 5 high-severity Dependabot alerts on main ([#2330](https://github.com/ltvmoon/WrenAI/issues/2330)) ([cee71e6](https://github.com/ltvmoon/WrenAI/commit/cee71e6444025599d0949b8761e9fdf23abf2c04))
...
* **wren:** document macOS memory first-run scan ([#2354](https://github.com/ltvmoon/WrenAI/issues/2354)) ([40b1a97](https://github.com/ltvmoon/WrenAI/commit/40b1a97caadd95dd5273519916c98578a210edda))
* **wren:** fix cube quickstart and align YAML/CLI examples with implementation ([#2359](https://github.com/ltvmoon/WrenAI/issues/2359)) ([be69509](https://github.com/ltvmoon/WrenAI/commit/be69509f06506ad89f299af1eaf9025a90ca50c6))
* **wren:** rebrand README to Wren AI and expand rename migration note ([#2316](https://github.com/ltvmoon/WrenAI/issues/2316)) ([f3a00eb](https://github.com/ltvmoon/WrenAI/commit/f3a00eb971a27186824954eff64b32f7e290db3c))


### Miscellaneous Chores

* **wren:** rename PyPI package from wren-engine to wrenai ([#2315](https://github.com/ltvmoon/WrenAI/issues/2315)) ([20cffa9](https://github.com/ltvmoon/WrenAI/commit/20cffa904f2d47c048c9247a77687b3fdfe24416))
